criaCartao(
    'Biologia',
    'Sobre a teoria da evolução de Darwin, o que ele não conseguiu demontrar em sua pesquisa?',
    'A origem das variações entre os indivíduos.')

criaCartao(
    'Biologia',
    'Qual a função da cartilgem elástica?',
    'As principais funções são: sustentação e flexibilidade. ')

criaCartao(
    'Química',
    'Qual a função dos ácidos carboxilicos?',
...
criaCartao(
    'Física',
    'Qual a definição de física óptica?',
    'Área da física que estuda os fenômenos relacionados à luz')

criaCartao(
    'Física',
    'O que é a Lei de Coulomb?',
    'Estabelece que a força eletrostática entre duas cargas elétricas é proporcional ao módulo das cargas elétricas e inversamente proporcional ao quadrado da distância que as separa.')
...
criaCartao(
    'Geografia',
    'Quais os prinicipais blocos econômicos? ',
    'União Europeia, Nafta, Opep, Apec, MCCA, Comunidade Andina, Mercosul, CEI, SADC')

criaCartao(
    'História',
    'O que é o Apothetai?',
    '“Local de exposição” onde os bebês espartanos eram supostamente deixados para morrer se fossem considerados inadequados')
